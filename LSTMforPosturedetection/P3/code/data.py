...
normalized_files = ["normalized_prone_windowed_labeled.csv","normalized_supine_windowed_labeled.csv","normalized_side_windowed_labeled.csv", "normalized_sitting_windowed_labeled.csv"]
